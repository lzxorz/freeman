<template>
  <a-card :bordered="false" class="card-area">
    ...
    <!-- 新增菜单 -->
    <menu-add @close="handleMenuAddClose" @success="handleMenuAddSuccess" :menuAddVisiable="menuAddVisiable"> </menu-add>
    <!-- 修改菜单 -->
    <menu-edit ref="menuEdit" @close="handleMenuEditClose" @success="handleMenuEditSuccess" :menuEditVisiable="menuEditVisiable"> </menu-edit>
    <!-- 新增按钮 -->
    <button-add @close="handleButtonAddClose" @success="handleButtonAddSuccess" :buttonAddVisiable="buttonAddVisiable"> </button-add>
    <!-- 修改按钮 -->
    <button-edit ref="buttonEdit" @close="handleButtonEditClose" @success="handleButtonEditSuccess" :buttonEditVisiable="buttonEditVisiable"> </button-edit>
  </a-card>
</template>
...
import {$getPermissions, $deletePermissionByIds} from '@/api'
  ...
  methods: {
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        centered: true,
        onOk () {
          $deletePermissionByIds({}, {ids: that.selectedRowKeys.join(',')}).then(() => {
    ...
    fetch (params = {}) {
      ...
      $getPermissions({...params}).then((r) => {
        let data = r.data
        this.loading = false
        this.dataSource = Object.is(data.data.children, undefined) ? data.data : data.data.children
      })
    }
  }
}
