 ...
 */
package com.freeman.common.reflect;
		...
		try {
			...
			for (int i=0; i<cs.length; i++){
				if (args[i] != null && !args[i].getClass().equals(cs[i])){
					...
					// // //	if(StrUtil.endsWith((String)args[i], ".0")){
					// // //		args[i] = StrUtil.substringBefore((String)args[i], ".0");
					// // //	}
					// // //}else if (cs[i] == Integer.class){
					// // //	args[i] = ObjectSerializer.toInteger(args[i]);
					// // //}else if (cs[i] == Long.class){
					// // //	args[i] = ObjectSerializer.toLong(args[i]);
					// // //}else if (cs[i] == Double.class){
					// // //	args[i] = ObjectSerializer.toDouble(args[i]);
					// // //}else if (cs[i] == Float.class){
					// // //	args[i] = ObjectSerializer.toFloat(args[i]);
					// // //}else if (cs[i] == Date.class){
					// // //	if (args[i] instanceof String){
					// // //		args[i] = DateUtil.parseDate((String) args[i]); //commons-lang3 DateUtils --> Hutool DateUtil
					// // //	}else{
					// // //		// POI Excel 日期格式转换
