...
public class AccountController {
    ...
    public R index(@PathVariable("userId") Long userId) {
        ...
        // 获取近期系统访问记录
        List<Map<String, Object>> lastSevenVisitCount = loginLogRepository.findLastSevenDaysVisitCount();
        data.put("lastSevenVisitCount", lastSevenVisitCount);

        List<Map<String, Object>> lastSevenUserVisitCount = loginLogRepository.findLastSevenDaysVisitCount(userId);
